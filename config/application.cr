...
Amber::Server.configure do |settings|
  ...
  #
  # settings.name = "Ludwig web application."
  #
  #
  ...
  #
  # settings.secret_key_base= IE86z0Hys3pjrRIzLshxQm0lL8idRX6MrPwFKvTiYfo
  #
  #
  ...
  #
  # settings.logger = Amber::Environment::Logger.new(File.open("ludwig.log", "w"))
  #
  #
end
